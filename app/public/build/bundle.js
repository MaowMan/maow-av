...
var app = (function () {
    ...
    function create_if_block_1$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h6, file$c, 16, 4, 371);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ is_downloading, Progress, message });
