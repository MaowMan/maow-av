...
var app = (function () {
    ...
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(15:6) <Field label=\\\"輸入影片網址：\\\">",
    		ctx
    	});
    ...
    // (18:6) <Button type="is-primary" iconPack="fas" iconLeft="heart" on:click={()=>get_token(target)}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(18:6) <Button type=\\\"is-primary\\\" iconPack=\\\"fas\\\" iconLeft=\\\"heart\\\" on:click={()=>get_token(target)}>",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$7, 13, 4, 361);
    			attr_dev(div1, "class", "columns is-centered");
    			add_location(div1, file$7, 12, 2, 322);
    			attr_dev(section, "class", "section");
    			add_location(section, file$7, 11, 0, 293);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	async function get_token(url) {
    		const token = await ipcRenderer.invoke("get-token", `${url}`);
    		console.log(token);
    	}
    	...
    	const click_handler = () => get_token(target);
    	...
    	return [target, get_token, input_value_binding, click_handler];
    }
